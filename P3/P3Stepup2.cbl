      ...
      *
       ...
       FILE-CONTROL.
           ...
           SELECT  PRINT-FILE  ASSIGN  "P3Stepup2.DOC"
                                    ORGANIZATION LINE SEQUENTIAL. 
      *
       DATA                      DIVISION.
       FILE                      SECTION. 
      ...
      * 
       ...
       PROCEDURE DIVISION.
            ...
            PERFORM UNTIL END-FLG = "E" 
                ...
                EVALUATE I-SURYO
                    WHEN 0  THRU 99  MOVE SPACE TO HOSI
                    WHEN 100 THRU 149  MOVE "*" TO HOSI
                    WHEN 150 THRU 199 MOVE "**" TO HOSI
                    WHEN 200 THRU 499 MOVE "***" TO HOSI
                    WHEN 500 THRU 999 MOVE "****" TO HOSI
